...
void Energy(int iblk) {
	...
	Ene.open("../../Results/Gibbs/output.energy.0",ios::app);
  ...
  Ene.close();
	...
	if(iblk == nblk){
   	ResultsU.open("../../Results/Gibbs/energy.result.0",ios::app);  
...
void SpecificHeath(int iblk) {
	...
	SpecificHeat.open("../../Results/Gibbs/output.specific_heat.0",ios::app);
  ...
  if(iblk == nblk){
    ResultsC.open("../../Results/Gibbs/specific_heat.result.0",ios::app);  
...
void Susceptibility(int iblk){
	...
	Susceptibility.open("../../Results/Gibbs/output.susceptibility.0",ios::app);
  ...
  if(iblk == nblk){
    ResultsX.open("../../Results/Gibbs/susceptibility.result.0",ios::app); 
...
void Magnetization(int iblk){
	...
	Magnetization.open("../../Results/Gibbs/output.magnetization.0",ios::app);
	...
	if(iblk == nblk){
   	ResultsM.open("../../Results/Gibbs/magnetization.result.0",ios::app);  
...
void Magnetization_h(int iblk){
	...
	Magnetization_h.open("../../Results/Gibbs/output.magnetization_h.0",ios::app);
	stima_m = blk_av[im]/blk_norm/(double)nspin; //Magnetizzazione
	glob_av[im]  += stima_m;
	glob_av2[im] += stima_m*stima_m;
	err_m=Error(glob_av[im],glob_av2[im],iblk);
	...
	if(iblk == nblk){
   	ResultsM_h.open("../../Results/Gibbs/magnetization_h.result.0",ios::app);  
