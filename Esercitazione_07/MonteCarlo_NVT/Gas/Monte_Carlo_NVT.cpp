...
void Print_Istant(){
    ofstream Epot, Pres;
    Epot.open("../../Results/MonteCarlo_NVT/Gas/istant.epot.0",ios::app);
    Pres.open("../../Results/MonteCarlo_NVT/Gas/istant.pres.0",ios::app);
...
void Averages(int iblk){ //Print results for current block
  ...
  Epot.open("../../Results/MonteCarlo_NVT/Gas/output.epot.0",ios::app);
  Pres.open("../../Results/MonteCarlo_NVT/Gas/output.pres.0",ios::app);
  Gofr.open("../../Results/MonteCarlo_NVT/Gas/output.gofr.0",ios::app);
  Gave.open("../../Results/MonteCarlo_NVT/Gas/output.gave.0",ios::app);
