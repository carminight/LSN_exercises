...
// distance i-j in pbc
     ...
     walker[igofr+int(dr/binSize)]+=2; //ho dr/binsize mi identifica in quale bin mi trovo
...
void Print_Istant(){
    ofstream Epot, Pres;
    Epot.open("../../Results/MonteCarlo_NVT/Solid/istant.epot.0",ios::app);
    Pres.open("../../Results/MonteCarlo_NVT/Solid/istant.pres.0",ios::app);
...
void Averages(int iblk){ //Print results for current block
  ...
  Epot.open("../../Results/MonteCarlo_NVT/Solid/output.epot.0",ios::app);
  Pres.open("../../Results/MonteCarlo_NVT/Solid/output.pres.0",ios::app);
  Gofr.open("../../Results/MonteCarlo_NVT/Solid/output.gofr.0",ios::app);
  Gave.open("../../Results/MonteCarlo_NVT/Solid/output.gave.0",ios::app);
