...
int main(){
  ...
  ofstream Term;
  Term.open("../../Results/Molecular_Dynamics_NVE/Solid/output_restart.out",ios::app);
...
void Averages(int iblk){ //Print results for current block
  ...
  Epot.open("../../Results/Molecular_Dynamics_NVE/Solid/ave_epot.out",ios::app);
  Pres.open("../../Results/Molecular_Dynamics_NVE/Solid/ave_pres.out",ios::app);
  Temp.open("../../Results/Molecular_Dynamics_NVE/Solid/ave_temp.out",ios::app);
  Ekin.open("../../Results/Molecular_Dynamics_NVE/Solid/ave_ekin.out",ios::app);
  Etot.open("../../Results/Molecular_Dynamics_NVE/Solid/ave_etot.out",ios::app);
  Gofr.open("../../Results/Molecular_Dynamics_NVE/Solid/output.gofr.0",ios::app);
  Gave.open("../../Results/Molecular_Dynamics_NVE/Solid/output.gave.0",ios::app);
