...
double vtail,ptail, numberOfBins, binSize;
...
double stima_pot,stima_pres,err_pot,err_press,stima_gdir,err_gdir,stima_temp,temperature, err_temp,stima_ekin,err_ekin,stima_etot,err_etot;
