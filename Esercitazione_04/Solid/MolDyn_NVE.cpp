...
int main(){
  ...
  ofstream Term;
  Term.open("../Results/Solid/output_restart.out",ios::app);
...
void Print_Istant(){  //Stampa i valori istantanei di pressione, energia potenziale, temperature, energia totale, energia cinetica
  ...
  Epot.open("../Results/Solid/output_epot.dat",ios::app);
  Pres.open("../Results/Solid/output_pres.dat",ios::app);
  Temp.open("../Results/Solid/output_temp.dat",ios::app);
  Etot.open("../Results/Solid/output_etot.dat",ios::app);
  Ekin.open("../Results/Solid/output_ekin.dat",ios::app);
...
void Averages(int iblk){ //Print results for current block
  ...
  Epot.open("../Results/Solid/ave_epot.out",ios::app);
  Pres.open("../Results/Solid/ave_pres.out",ios::app);
  Temp.open("../Results/Solid/ave_temp.out",ios::app);
  Ekin.open("../Results/Solid/ave_ekin.out",ios::app);
  Etot.open("../Results/Solid/ave_etot.out",ios::app);
