...
int main(){
  ...
  ofstream Term;
  Term.open("../Results/Gas/output_restart.out",ios::app);
  ...
  Term.close();
	...
	cout << "Temperature after the thermalization: " << stima_temp << endl;
	cout << endl << endl;
...
void Averages(int iblk){ //Print results for current block
  ...
  Epot.open("../Results/Gas/ave_epot.out",ios::app);
  Pres.open("../Results/Gas/ave_pres.out",ios::app);
  Temp.open("../Results/Gas/ave_temp.out",ios::app);
  Ekin.open("../Results/Gas/ave_ekin.out",ios::app);
  Etot.open("../Results/Gas/ave_etot.out",ios::app);
