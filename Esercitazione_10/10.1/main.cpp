...
int main (){
	...
	Walker1.BestPath("../Results/10.1/path_circle.out");
 	Walker1.BestDistanceAnnealing("../Results/10.1/distance_circle.out");
	...
	Walker2.BestPath("../Results/10.1/path_square.out");
  	Walker2.BestDistanceAnnealing("../Results/10.1/distance_square.out");
