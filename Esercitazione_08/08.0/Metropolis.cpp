...
//Costruttore
Metropolis::Metropolis(Function *DistributionToBeSampled, vector <double> InitialPositions, double StepWidth, int NumberOfSteps, int Dimensions, int MCSteps, int NumberOfBins): _NextPositions(Dimensions), _Psi(NumberOfBins, vector<double>(MCSteps)){
